...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      'focus-visible:ring-ring peer inline-flex h-[22px] w-[40px] shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[#FFFFFF] disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-[#0344E9] data-[state=unchecked]:bg-[#B0A8A8]',
      className,
    )}
    {...props}
    ref={ref}
