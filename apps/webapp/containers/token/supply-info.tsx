        ...
        <div className='flex flex-col gap-2'>
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-11'>
            <div className='card-gradient-secondary flex flex-col items-center justify-center gap-2 rounded-lg p-5'>
              <div className='flex items-center gap-2'>
                <p className='subtitle2 text-[#E3E3E3]'>Max LTV</p>
                {/* Info Icon replace */}
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='16'
              ...
              <p className='number2'>67.00%</p>
            </div>
            <div className='card-gradient-secondary flex flex-col items-center justify-center gap-2 rounded-lg p-5'>
              <div className='flex items-center gap-2'>
                <p className='subtitle2 text-[#E3E3E3]'>Liquidation threshold</p>
                {/* Info Icon replace */}
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='16'
              ...
              <p className='number2'>80.00%</p>
            </div>
            <div className='card-gradient-secondary flex flex-col items-center justify-center gap-2 rounded-lg p-5'>
              <div className='flex items-center gap-2'>
                <p className='subtitle2 text-[#E3E3E3]'>Liquidation penalty</p>
                {/* Info Icon replace */}
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='16'
